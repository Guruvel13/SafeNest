...
import {
    Check, Shield, Wifi, User, Coffee, Lock, Star, ChevronRight, ChevronLeft,
    Menu, X, Instagram, Facebook, Twitter, MapPin, Mail, Phone,
    Zap, Heart, Home, Users, MessageCircle, Map as MapIcon, Battery
} from 'lucide-react';
                                        ...
                                        <AnimatePresence mode="wait">
                                            ...
                                            >
                                                ...
                                                <div className={`w-full h-full ${activeCamera === 0 ? 'bg-indigo-950' : activeCamera === 1 ? 'bg-slate-900' : 'bg-purple-950'} flex flex-col items-center justify-center`}>
                                                    ...
                                                    {activeCamera === 0 ? (
                                                        <img src={securityImg} className="w-full h-full object-cover opacity-80 mix-blend-overlay" alt="Security Feed" />
                                                    ) : (
